      ...
      <div className="content">
        ...
        {activeTab === 'dashboard' && (
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
              <h2 style={{ color: 'var(--military-gold)', fontSize: '24px', margin: 0 }}>Company Overview</h2>
              <button 
            ...
            {showManagement ? (
              <div className="form-container">
                ...
                <h3 style={{ color: 'var(--military-gold)', marginBottom: '20px', fontSize: '20px' }}>Manage Companies</h3>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '12px', marginBottom: '40px' }}>
                  {companies.map(company => (
                    <div key={company} style={{ 
                      ...
                      <span style={{ color: 'var(--military-gold)', fontWeight: 600 }}>{company} Company</span>
                      <button 
                ...
                <h3 style={{ color: 'var(--military-gold)', marginBottom: '20px', fontSize: '20px' }}>Manage Ranks</h3>
                <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
                  <input 
                    type="text"
                    value={newRank}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '12px' }}>
                  {ranks.map(rank => (
                    <div key={rank} style={{ 
                      ...
                      <span style={{ color: 'var(--military-gold)', fontWeight: 600 }}>{rank}</span>
                      <button 
                    ...
                    <div key={company} className="company-card">
                      ...
                      <div className="stats-grid">
                        ...
                        <div className="stat-card others">
                          ...
                          <span className="value">{stats.others}</span>
                        </div>
                      </div>
                    </div>
                  );
        ...
        {activeTab === 'attendance' && (
          <div className="form-container">
            ...
            <div style={{ background: 'var(--dark-bg)', borderLeft: '4px solid var(--military-gold)', padding: '16px', borderRadius: '8px', marginBottom: '20px' }}>
              <div style={{ color: 'var(--military-gold)', fontSize: '13px', fontWeight: 600, marginBottom: '4px' }}>TODAY'S DATE</div>
                ...
                <table>
                  ...
                  <tbody>
                    {filteredRecords.map((record, index) => (
                      <tr key={record.id}>
                        <td>{index + 1}</td>
                        <td><strong style={{ color: 'var(--military-gold)' }}>{record.regNo}</strong></td>
            ...
            <div className="ranks-grid">
              {Object.entries(getRankStats(selectedCompany)).map(([rank, count]) => (
                <div key={rank} className="rank-card">
                  ...
                  <div style={{ color: 'var(--military-gold)', fontSize: '13px', fontWeight: 700, marginBottom: '4px' }}>{rank}</div>
                  <div style={{ color: 'var(--text-dim)', fontSize: '12px' }}>{count} soldiers</div>
                </div>
              ))}
            </div>
